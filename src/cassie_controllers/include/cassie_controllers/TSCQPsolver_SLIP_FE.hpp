#ifndef TSCQPSOLVER_SLIP_FE_HPP
#define TSCQPSOLVER_SLIP_FE_HPP
...
class TSCQPsolver_SLIP_FE {
public:
    TSCQPsolver_SLIP_FE(ros::NodeHandle &nh, cassie_model::Cassie &robot, int control_mode);
...
private:
    struct Config{
        ...
        int usize;
        int othercons_size;
        int fesize;         // force embedding constraints
        int nV;
        int nC;

#ifndef IDTSCQPSOLVER_DEBUG_HPP
#define IDTSCQPSOLVER_DEBUG_HPP
...
class TSCQPsolver_DEBUG {
public:
    TSCQPsolver_DEBUG(ros::NodeHandle &nh, cassie_model::Cassie &robot, int control_mode);
    void update( VectorXd &u, OUTPUT_DEBUG &output); //update control input
    void reset();
    bool reconfigure();
...
private:
    ...
    VectorXd getTorqueQP(OUTPUT_DEBUG &output);

};

#endif //IDTSCQPsolver_DEBUG_HPP
